...
export function TaskAutoReviewModal({
  pr,
  taskTitle,
  onClose,
  onChanged
}: TaskAutoReviewModalProps) {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        ...
        data-testid="taskauto-review-modal"
                ...
                <div className="pr-info">
                  ...
                  {details?.taskNotes && (
                    <div className="pr-info__description">
                      <h4>Plan</h4>
                      <div
                        className="pr-description taskauto-review__plan"
                  ...
                  <a
                    ...
                    className="btn btn--secondary btn--sm taskauto-review__github-link"
                  >
                    View on GitHub
                  </a>
                </div>
